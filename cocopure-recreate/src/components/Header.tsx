      ...
      <nav className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
            ...
            {navigation.map((item) => (
              <div key={item.path} className="relative group">
                {item.submenu ? (
                  ...
                  <button
                    className={`flex items-center space-x-1 py-2 transition-colors text-white hover:text-gray-200`}
                  ...
                  <Link
                    to={item.path}
                    className={`py-2 transition-colors text-white hover:text-gray-200`}
                  >
                    {item.title}
                  </Link>
                )}
          ...
          <button
            ...
            className={`md:hidden p-2 rounded-lg transition-colors text-white hover:text-gray-200`}
          >
            {isMenuOpen ? (
              <X className="h-6 w-6" />
            ) : (
                ...
                {item.submenu ? (
                  <div>
                    <button
                      onClick={() =>
                        setActiveMenu(
                          activeMenu === item.path ? null : item.path
                        )
                      }
